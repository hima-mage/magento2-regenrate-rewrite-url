...
namespace HimaMage\Model;

use HimaMage\RegenerateUrlRewrites\Helper\Regenerate as RegenrateHelper;
use Magento\Framework\App\ResourceConnection;
use Magento\UrlRewrite\Model\Storage\DbStorage;
use Magento\CatalogUrlRewrite\Model\Category\Product as ProductUrlRewriteResource;
...
abstract  class AbstractRegenerateRewrites
{
    ...
    protected function _showProgress($size = 70)
    {
        ...
        echo $status_bar;
        flush(); // flush — Flush system output buffer
